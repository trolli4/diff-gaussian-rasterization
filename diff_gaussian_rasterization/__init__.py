...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        num_rendered, color, radii, geomBuffer, binningBuffer, imgBuffer, invdepths, residual_opacity_pixels = _C.rasterize_gaussians(*args)
        ...
        return color, radii, invdepths, residual_opacity_pixels
